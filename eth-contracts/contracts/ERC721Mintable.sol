...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId),"tokenId is already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId),"from has to be the owner of the token");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint tokenId) internal {
        require(_exists(tokenId),"tokenID does n't exist");
...
//      -calls the superclass mint and setTokenURI functions
    ...
    contract ERC721Token is ERC721Metadata("Real Estate Listing","REL","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
